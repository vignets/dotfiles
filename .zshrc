...
plugins=(git zsh-syntax-highlighting zsh-autosuggestions history-sync)
...
export FZF_DEFAULT_OPTS="--multi --height=60% --reverse --border --inline-info --preview '([ -e {} ] && (head -20 {} || tree -C {} | head -20 ) || (echo {})) 2> /dev/null' --preview-window=down:4:wrap"
